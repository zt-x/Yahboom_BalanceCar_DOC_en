...
### method
#### delay_init(void)
Initialized stalled function<br>
...
<tbody>
    <tr><td>n</td><td>uint16_t</td><td>Delay time (millisecond)</td></tr>
</tbody>
</table>

#### delay_us(uint32_t n)

Delay N microsecond<br>
<table>
<thead class="table100-head">
<tr><th>parameter</th><th>type</th><th>Annotation</th></tr>
</thead>
<tbody>
    <tr><td>n</td><td>uint16_t</td><td>Delay time (microsecond)</td></tr>
</tbody>
</table>
